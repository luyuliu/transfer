...
def analyze_transfer(single_date, monte_carlo_range):
    dic_stops = {}
    ...
    for key, value in dic_stops.items():
        ...
        if ii ==3: 
            print(monte_carlo_range, key, ave_TTP, trans_risk)
            break
        ii+=1

    '''
    location = 'D:/Luyu/transfer_data/all_year/monte/test1.shp'
    print(location)
...
if __name__ == '__main__':
    ...
    range_dic = [0,5,10,20,30,40,50,60,80,100,120,150,180,210,240,270,300,400,500,600,700,800,900,1000,1200,1500,1800]
    for i in range_dic:
        analyze_transfer(each_date, i)
