...
def analyze_transfer(start_date, end_date):
    ...
    for single_date in date_range:
        ...
        if total_transfer>0:
            print(today_date, len(dic_stops), total_transfer, round(total_TTP/total_transfer,2), round(total_missed_transfer/total_transfer,4), deviant_dedicated_transfer, total_dedicated_transfer, a_transfer, b_transfer, a_TTP, b_TTP, a_one_transfer, b_one_transfer, a_two_transfer, b_two_transfer)
        else:
            print(today_date, 0)
