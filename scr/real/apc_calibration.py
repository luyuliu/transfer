...
def paralleling_transfers(single_date):
    ...
    col_gtfs_real_time = db_gtfs_realtime["R" + today_date]
    print(today_date)
    ...
    for each_transfer in db_schedule:
        ...
        real_transfer["a_t"] = each_transfer["a_time"] + today_seconds  # time gap

        real_transfer["b_st"] = b_stop_id
        real_transfer["b_tr"] = b_trip_id
        real_transfer["b_ro"] = each_transfer["b_route_id"]
        real_transfer["b_t"] = each_transfer["b_time"] + today_seconds  # time gap
...
if __name__ == '__main__':
    ...
    # paralleling_transfers(date(2018, 6, 1))
