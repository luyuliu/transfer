...
def analyze_transfer(start_date, end_date):
    ...
    for single_date in date_range:
        ...
        deviant_dedicated_transfer = 0
        deviant_a_transfer = 0
        deviant_b_transfer = 0
        ...
        for single_result in db_result:
            ...
            if single_result['status'] < 3:
                ...
                if single_result['b_ro']*single_result['b_ro'] == dedicated_line*dedicated_line or single_result['a_ro']*single_result['a_ro'] == dedicated_line*dedicated_line:
                    total_dedicated_transfer=total_dedicated_transfer+1
                    '''if single_TTP<3600 and single_TTP>-100:
                ...
                if single_TTP>3600:
                    deviant_dedicated_transfer = deviant_dedicated_transfer+1
                    if single_result['a_ro']*single_result['a_ro'] == dedicated_line*dedicated_line:
                        deviant_a_transfer = deviant_a_transfer+1
                    elif single_result['b_ro']*single_result['b_ro'] == dedicated_line*dedicated_line:
                        deviant_b_transfer = deviant_b_transfer+1
                    # print(single_result['a_ro'],single_result['b_ro'], single_TTP)
        ...
        if total_transfer>0:
            print(today_date, len(dic_stops), total_transfer, round(total_TTP/total_transfer,2), round(total_missed_transfer/total_transfer,4), deviant_dedicated_transfer, total_dedicated_transfer, deviant_a_transfer, deviant_b_transfer)
        else:
            print(today_date, 0)

    location = 'D:/Luyu/transfer_data/all_year/dedicated/test.shp'
    print(location)
...
if __name__ == '__main__':
    ...
    start_date1 = date(2018, 9, 5)
    end_date1 = date(2018, 11, 3)
